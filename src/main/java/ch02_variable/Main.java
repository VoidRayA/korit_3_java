...
//        System.out.println("안녕하세요, 제 이름은 유지현입니다.");
////        System.out.println(안녕하세요, 제 이름은 유지현입니다.);
...
//        // 2. 문자 자료형 변수 char
//        char name1 = '유';                 // 문자를 입력할 때는 작은 따옴표(')로 감싼다.
//        char name2 = '지';                 // char : character의 축약어 알파벳/한글/숫자 하나
//        char name3 = '현';                 // 문자 =/= 문자열
//
//        System.out.println(name1 + name2 + name3);  //157412
//
//        System.out.println("" + name1 + name2 + name3); //유지현
//
...
//        문자'열'로 인식되게금 꼼수를 부린 부분이 58번 라인에 해당합니다.
//
//        여기서 알 수 있는 점은 sout()의 가장 먼저 나온 데이터의 자료형을 따라간드는 점입니다.
//            증거
//        */
...
//
//        String a = "제 이름은 유지현입니다. 나이는 34살입니다.";
//
...
//        System.out.println(example1 + example2);
        ...
        // 이상의 ㅣ선언된 변수를 기준으로 적절한 여러분의 데이터로 초기화하고,
        ...
        System.out.println("저는 코리아 it 아카데미 3월 국비 과정을 수강하고 있는 " + name1 + "입니다. " + age1 + "살입니다.\n"
                + "제\t 전공은 " + major1 + "이며, " + "mbti는 " + mbti1 + "입니다. " + "열심히 할게요!!!");
