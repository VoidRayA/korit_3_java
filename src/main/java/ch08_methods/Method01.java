...
public class Method01 {
    ...
    public static void main(String[] args) {
        ...
        myAge = scanner.nextInt();                  // 이거 메서드 호출의 결과를 myAge이라는 변수에 담았죠
        ...
        // 위의 코드는 위의 결과값들을 새로운 메서드인 introduce()의 name, age
...
//        System.out.println(writeMyage(34)); // 여전히 불편한 지점입니다.
//        writeMyage2(34);
//
//        int nextAge = writeMyage(34) + 1;
//        System.out.println(nextAge);
//
//        int nextAge2 = writeMyage2(34) + 1;
