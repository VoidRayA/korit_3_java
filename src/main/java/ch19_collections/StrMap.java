...
public class StrMap {
    public static void main(String[] args) {
        ...
        //[kor2025008=유지현, kor2025007=양지은, kor2025009=윤현지, kor2025004=김준식, kor2025015=한영진, kor2025003=김미진,
        ...
        // Key Set 출력 -> strMap의 제네릭의 첫 번째 매개변수인 Key에 해당하는 자료형을 넣어야 함.
        ...
        // 키의 개수와 값의 개수가 달라지게 될 위험성이 있어 Collection을 사용함(Collections X)
    }
}
