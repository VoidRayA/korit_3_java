...
public class StrList {
    ...
    public static void main(String[] args) {
        ...
        int[] intArray = new int[3];        // 인덱스 넘버를 고정시켜야함
        ...
        System.out.println(strList);    // toString()이 정의되있음.
        ...
        boolean removed2 = strList.contains(removeElem2);
        ...
        // List의 특정 element 출력 -> 꺼내야 연산이 가능함
